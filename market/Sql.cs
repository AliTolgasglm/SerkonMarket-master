...
namespace market
{
    public class Sql
    {
        private readonly string connectionString = "Data Source=DESKTOP-DEEO0V8\\MSSQLSERVER1;Initial Catalog=SERKONMARKET;Integrated Security=True;Trust Server Certificate=True";
